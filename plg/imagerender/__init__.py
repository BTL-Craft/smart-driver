...
async def _html2pic(bot: Bot, event: MessageEvent):
    ...
    # html 可使用本地资源
    async with get_new_page(viewport={"width": 1500, "height": 1800}) as page:
        await page.goto(
            "http://btl-craft.test.upcdn.net/help/faq",
            wait_until="networkidle",
        )
        pic = await page.screenshot(full_page=True, path="./html2pic.png", scale="css")
